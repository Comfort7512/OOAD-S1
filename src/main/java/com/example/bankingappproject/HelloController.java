...
import static com.example.bankingappproject.HelloApplication.mainstage;
...
public class HelloController {
    ...
    public void toDash() throws IOException {
     ...
     public void toInvestmentAccount() throws IOException {
         FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("Investement.fxml"));
         Scene scene = new Scene(fxmlLoader.load());
         mainstage.setScene(scene);
         mainstage.show();
     }
